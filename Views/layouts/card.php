  ...
  <div class="card w-100 h-100" style="width: 18rem;">
    ...
    <div class="card-body d-flex flex-column">
      ...
      <?php if(get_class($product) === 'Food'){ ?>
        ...
        <span class="card-text"><span class="fw-bold">Lista degli ingredienti: </span><?php echo implode(", ", $product->getIngrediets()); ?></span>
      ...
      <?php }elseif(get_class($product) === 'Games'){ ?>
        ...
        <span class="card-text"><span class="fw-bold">Lista dei materiali: </span><?php echo implode(", ", $product->getMaterial()); ?></span>
